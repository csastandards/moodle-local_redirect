...
$string['privacy:metadata'] = 'The Redirect plugin does not store any personal data about any user.';
$string['globalhelp'] = 'Redirects user processing url through Moodle filters';
